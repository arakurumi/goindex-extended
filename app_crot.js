...
<div class="mdui-container">
    ...
    <h1 id="welcome-sekai">Selamat Datang di SeKai Drive!</h1>
    <br>
    <h1 id="Telegram">Telegram Groups :</h1>
    <a href="https://discord.gg/6aZPrn6ndw"><img src="https://i.ibb.co/KwcM0x4/discord-v2.png" alt=""></a>
    <h1 id="Donate">Support Me :</h1>
    <br>
    <script type='text/javascript' src='https://cdn.trakteer.id/js/embed/trbtn.min.js'></script><script type='text/javascript'>(function(){var trbtnId=trbtn.init('Dukung Saya di Trakteer','#be1e2d','https://trakteer.id/kqrumi','https://cdn.trakteer.id/images/embed/trbtn-icon.png','40');trbtn.draw(trbtnId);})();</script>
