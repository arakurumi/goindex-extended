...
function list(path) {
  ...
  <i class="mdui-icon material-icons icon-sort" data-sort="size" data-order="downward">expand_more</i>
	...
	`;
  var head_md = `
  <div id="head_md" class="mdui-typo nexmoe-item" style="padding: 20px 0px;"><p><img src="https://telegra.ph/file/7c1083d15ecf856397e9a.png" alt=""></p>
  <h1 id="welcome-sekai"><center>Welcome to SeKai Drive!</center></h1>
  <br>
  <h1 id="Telegram">Telegram Groups :</h1>
  <a href="https://t.me/arakurumi"><img src="https://telegra.ph/file/ad39d4877cf0958ee96a3.png" alt="" width="80" height="80"></a>
  <br>
  <h1 id="Donate">Apasih Ngabs :</h1>
  <p><a href="https://trakteer.id/kqrumi" target="_blank"><img id="wse-buttons-preview" src="https://cdn.trakteer.id/images/embed/trbtn-red-6.png" height="40" style="border:0px;height:40px;" alt="Trakteer Saya"></a></p>
  </div>
  `
